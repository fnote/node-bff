...
const routes = [
  ...
  { path: '/batch/signed-url/input', method: POST },
  { path: '/batch/signed-url/output', method: POST },
  { path: '/batch/users/{userId}/jobs', method: GET },
  { path: '/batch/users/{userId}/jobs/{jobId}', method: DELETE },
